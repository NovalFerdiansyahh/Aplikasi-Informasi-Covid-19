...
import com.example.infocovid_19_novalferdiansyah_24.model.IndonesiaResponse
    ...
    private fun  showIndonesia(){
        RetrofitClient.instance.getIndonesia().enqueue(object :
            ...
            override fun onResponse(
                ...
                val dirawat :TextView = findViewById(R.id.tvHospitalized)
                dirawat.text=hospitilized
                val sembuh :TextView = findViewById(R.id.tvRecover)
                sembuh.text=recover
                val meninggal :TextView = findViewById(R.id.tvDeath)
                meninggal.text=death
            }
